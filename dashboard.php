...
?>
    ...
    <div class="flex items-center justify-between p-6 bg-gradient-to-r from-blue-500 to-purple-600 shadow-lg text-white">
        <h2 class="text-2xl font-semibold">Welcome, <?php echo $name; ?></h2>
        <p class="italic"><?php echo $email; ?></p>

        <div class="space-x-4">
            <a href="cart.php" class="bg-blue-400 hover:bg-blue-600 hover:text-white p-2 rounded-full shadow-md transition duration-300 ease-in-out">Cart</a>
            <a href="contactus.php" class="bg-green-400 hover:bg-green-600 hover:text-white p-2 rounded-full shadow-md transition duration-300 ease-in-out">Contact Us</a>
            <a href="index1.php" class="bg-yellow-400 hover:bg-yellow-600 hover:text-white p-2 rounded-full shadow-md transition duration-300 ease-in-out">Home</a>
            <a href="logout.php" class="bg-red-400 hover:bg-red-600 hover:text-white p-2 rounded-full shadow-md transition duration-300 ease-in-out">Sign Out</a>
        </div>
    </div>
            ...
            <div class="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-shadow duration-300">
                ...
                <div class="p-6">
                    <div class="flex items-center justify-between">
                        ...
                        <button class="text-red-500 text-2xl transition-transform duration-300 hover:scale-125">&#9829;</button>
                    </div>
                    <p class="text-gray-700 mt-2">Price: Rs.300</p>
                    <div class="flex justify-between mt-6">
                        <button class="bg-green-500 text-white px-4 py-2 rounded-lg hover:bg-green-600 transition-colors duration-300">Add to Cart</button>
                        <button class="bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 transition-colors duration-300">Buy Now</button>
                    </div>
                </div>
            </div>
